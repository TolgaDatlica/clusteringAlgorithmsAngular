...
import { MLSPageService } from './mlspage.service';
...
@Component({
  selector: 'mlspage',
  styleUrls: ['mlspage.component.scss'],
  templateUrl: './mlspage.component.html',
})
export class MLSPageComponent implements OnInit, AfterViewInit {
  public graph = {
    data: [],
  ...
  */
  ...
  wifilist = [];
  constructor(private mainPageService: MLSPageService, private renderer: Renderer2, private elementRef: ElementRef,
              private sampleService: MLSPageService) {
  }
  ngAfterViewInit() {
  }
  ngOnInit() {
