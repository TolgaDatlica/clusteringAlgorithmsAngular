...
@Injectable()
export class NavizonPageService {
    ...
    public getWifiResult(macObject): Observable<any> {
        debugger;
        let result = {};
        if (macObject.wifiAccessPoints[0].signal_strength === -84) {
            result = [{
                "latitude": 39.8764351034483,
                "longitude": 32.8637414137931,
                "radius": "50",
                "location_type": "WiFi"
            },
            {
        ...
        } else if (macObject.wifiAccessPoints[0].signal_strength === -91) {
            result = {
                "latitude": 39.8992040472441,
                "longitude": 32.8464096377953,
                "radius": "40",
                "location_type": "WiFi"
            };
        } else if (macObject.wifiAccessPoints[0].signal_strength === -68) {
            result = {
                "latitude": 39.8996139230769,
                "longitude": 32.8464662797203,
                "radius": "35",
                "location_type": "WiFi"
            };
        } else if (macObject.wifiAccessPoints[0].signal_strength === -67) {
            result = {
                "latitude": 39.8767352479675,
                "longitude": 32.864938703252,
                "radius": "35",
                "location_type": "WiFi"
            };
        } else if (macObject.wifiAccessPoints[0].signal_strength === -72) {
            result = {
                "latitude": 39.876915431579,
                "longitude": 32.8650159649123,
                "radius": "35",
                "location_type": "WiFi"
            };
        }
